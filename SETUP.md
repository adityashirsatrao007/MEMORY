...
> Proprietary — see [LICENSE](LICENSE). No copying, cloning, or distribution.

---

## Setup Prompt

Copy the entire block below and paste it into **Antigravity** (or any agent) on your new machine. Works on **Linux**, **macOS**, and **Windows (WSL2)**.
